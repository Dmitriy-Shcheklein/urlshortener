...
func TestGenerateNewCookie(t *testing.T) {
	t.Run("Успешное создание cookie с корректными параметрами", func(t *testing.T) {
	...
	t.Run("Cookie value имеет правильный формат", func(t *testing.T) {
		cookie, err := generateNewCookie()
...
func TestVerifyToken(t *testing.T) {
	...
	t.Run("Невалидный формат - нет разделителя", func(t *testing.T) {
		setup(t)
	...
	t.Run("Невалидный формат - пустая строка", func(t *testing.T) {
		setup(t)
	...
	t.Run("Невалидный формат - несколько разделителей", func(t *testing.T) {
		setup(t)
	...
	t.Run("Невалидный формат - только разделители", func(t *testing.T) {
		setup(t)
		cookie = &http.Cookie{Value: ".."}
	...
	t.Run("Невалидная подпись HMAC", func(t *testing.T) {
		setup(t)
	...
	t.Run("Невалидный base64 в encodedUserID", func(t *testing.T) {
		setup(t)
	...
	t.Run("Успешная верификация с валидным generated cookie", func(t *testing.T) {
		setup(t)
		validCookie, err := generateNewCookie()
		require.NoError(t, err)
	...
	t.Run("Успешная верификация с вручную созданным валидным cookie", func(t *testing.T) {
		setup(t)
		manualCookie, err := generateNewCookie()
		require.NoError(t, err)
...
func TestAuthMiddleware(t *testing.T) {
	...
	t.Run("Нет cookie - успешное создание нового", func(t *testing.T) {
		setup(t)
	...
	t.Run("Нет cookie - NextHandler вызывается", func(t *testing.T) {
		setup(t)
	...
	t.Run("Нет cookie - Response Header содержит Set-Cookie", func(t *testing.T) {
		setup(t)
	...
	t.Run("Нет cookie - Response Code не равен 500", func(t *testing.T) {
		setup(t)
	...
	t.Run("Существующий валидный cookie", func(t *testing.T) {
		setup(t)
	...
	t.Run("Существующий валидный cookie - UserID в контексте", func(t *testing.T) {
		setup(t)
	...
	t.Run("Существующий cookie - неверный формат (нет разделителя)", func(t *testing.T) {
		setup(t)
	...
	t.Run("Существующий cookie - неверная подпись", func(t *testing.T) {
		setup(t)
	...
	t.Run("Checker для извлечения UserID из контекста", func(t *testing.T) {
		setup(t)
		...
		handlerWithCheck := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
