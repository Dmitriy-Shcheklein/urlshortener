...
// Audit provides a mock function for the type MockAuditor
func (_mock *MockAuditor) Audit(userID *string, action string, URL string) {
	_mock.Called(userID, action, URL)
	return
}

// MockAuditor_Audit_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Audit'
type MockAuditor_Audit_Call struct {
	*mock.Call
}
...
//   - action string
//   - URL string
func (_e *MockAuditor_Expecter) Audit(userID interface{}, action interface{}, URL interface{}) *MockAuditor_Audit_Call {
	return &MockAuditor_Audit_Call{Call: _e.mock.On("Audit", userID, action, URL)}
}

func (_c *MockAuditor_Audit_Call) Run(run func(userID *string, action string, URL string)) *MockAuditor_Audit_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *string
		if args[0] != nil {
			arg0 = args[0].(*string)
...
func (_c *MockAuditor_Audit_Call) Return() *MockAuditor_Audit_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockAuditor_Audit_Call) RunAndReturn(run func(userID *string, action string, URL string)) *MockAuditor_Audit_Call {
	_c.Run(run)
	return _c
}
